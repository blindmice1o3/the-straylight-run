...
//            }
        ...
        SceneHouseLevel01.getInstance().init(game);
        SceneHothouse.getInstance().init(game);
        SceneChickenCoop.getInstance().init(game);
        SceneCowBarn.getInstance().init(game);

        allScenes.add(SceneFarm.getInstance());

        allScenes.add(SceneHouseLevel01.getInstance());
        allScenes.add(SceneHothouse.getInstance());
        allScenes.add(SceneChickenCoop.getInstance());
        allScenes.add(SceneCowBarn.getInstance());
    }
    ...
    public void reload(Game game) {
        ...
        for (int i = 0; i < allScenes.size(); i++) {
            ...
            if (scene instanceof SceneFarm) {
                ...
                SceneHome02.setInstance((SceneHome02) scene);
            } else if (scene instanceof SceneHouseLevel01) {
                SceneHouseLevel01.setInstance((SceneHouseLevel01) scene);
            } else if (scene instanceof SceneHothouse) {
                SceneHothouse.setInstance((SceneHothouse) scene);
            } else if (scene instanceof SceneChickenCoop) {
                SceneChickenCoop.setInstance((SceneChickenCoop) scene);
            } else if (scene instanceof SceneCowBarn) {
                SceneCowBarn.setInstance((SceneCowBarn) scene);
            }
        }

        SceneFarm.getInstance().reload(game);

        SceneChickenCoop.getInstance().reload(game);

        SceneCowBarn.getInstance().reload(game);

        SceneHothouse.getInstance().reload(game);

        SceneHouseLevel01.getInstance().reload(game);
